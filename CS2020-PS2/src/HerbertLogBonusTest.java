...
public class HerbertLogBonusTest {
	...
	public void testVeryShortNamesGoalIncome() {
		...
		long numMinutes = log.calculateMinimumWork(30);
		assertEquals("veryShortNamesGoalIncome - $30", 1, numMinutes);

		numMinutes = log.calculateMinimumWork(52);
	...
	public void testShortNamesGoalIncome() {
		...
		long numMinutes = log.calculateMinimumWork(279);
		...
		numMinutes = log.calculateMinimumWork(401);
	...
	public void testManyNamesGoalIncome() {
		...
		long numMinutes = log.calculateMinimumWork(13320);
		...
		numMinutes = log.calculateMinimumWork(47803);
	...
	public void testLongNamesGoalIncome() {
		...
		long numMinutes = log.calculateMinimumWork(1);
